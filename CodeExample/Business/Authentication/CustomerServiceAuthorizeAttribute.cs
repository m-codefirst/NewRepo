...
{
    public class CustomerServiceAuthorizeAttribute : AuthorizeAttribute
    {
        public bool JsRedirect { get; set; }
        private readonly IAmBullionContactHelper _bullionContactHelper;
        private readonly CustomerContext _customerContext;
        public CustomerServiceAuthorizeAttribute()
        {
        ...
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            if (_bullionContactHelper.IsCustomerServiceAccount(currentContact)) return;
            if (JsRedirect)
            {
                filterContext.Result = new JavaScriptResult()
                {
