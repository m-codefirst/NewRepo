var Coupons = {
    init: function init() {
        $(document).on('click', '.jsUpdateCoupon', Coupons.updateCoupon).on('click', '.jsDeleteCoupon', Coupons.deleteCoupon);
    },
    getFormData: function getFormData(form, rowData, actionType) {
        var record = {
    ...
    updateCoupon: function updateCoupon() {
        ...
        axios.post(form[0].action, formData).then(function (result) {
